public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("La temp esterna media è di " + averageExtTemp(sensors, new SensorExtTempGetter()) + " gradi");
    }

    public static double averageExtTemp(Sensor[] sensors, PropertyGetter pGetter){
        double sum = 0;
